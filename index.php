...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top">
  <a class="navbar-brand" href="#"><img src="js/img/Files_Download.png" width="33px" height="33px"> <font color="#F0B56F">L</font>egacy <font color="#F0B56F">F</font>foundation <font color="#F0B56F">A</font>cademy</a>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="www.facebook.com">
          <i class="fas fa-user"></i> facebook</a>
      </li>

      </li>
      <li class="nav-item">
        <a class="nav-link" href="chambagaabudlah@gmail.com">
          <i class="fas fa-user"></i> In</a>
       ...
       <li class="nav-item">
        <a class="nav-link" href="resgister.php">
...
<div class="container col-md-10">
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div data-p="170">
                <img data-u="image" src="bck2.jpg" />
                <div data-t="0" style="position:absolute;top:320px;left:30px;width:800px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);">Welcome to legacy foundations </div>
            </div>
            <div data-p="170">
                <img data-u="image" src="img2.jpg" />
                <div data-t="1" style="position:absolute;top:-50px;left:125px;width:800px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);">Become  Good in networking </div>
            </div>
            <div data-p="170">
                <img data-u="image" src="img3.jpg" />
                <div data-t="2" style="position:absolute;top:30px;left:-505px;width:800px;height:40px;font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;background-color:rgba(255,188,5,0.8);">Less time spent  and become a good programmer </div>
            </div>
            <div data-p="170">
  ...
  <Br><Br>
    <div class="container col-md-11 ">
      <h3>Welcome To Legacy Foundation Academy</h3>
      <hr></hr>
      <p class="aaa">
